...
//     );
  ...
  //   // 개발자 도구로 확인해보면 React.Fragment는 별도의 엘리먼트로 나타나지 않음
  //   // <React.Fragment>
  //   //   <div>안녕하세요.</div>
  //   //   <div>안녕히계세요.</div>
  //   // </React.Fragment>
  ...
  // camelCase 형태로 네이밍(backgroundColor)
...
export default JsxUse; // JsxUser라는 컴포넌트(=함수) 내보내기
